...
export class CreatTableTypeVaccine1713726383492 implements MigrationInterface {
    name = 'CreatTableTypeVaccine1713726383492'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`vaccine\` (\`id\` int NOT NULL AUTO_INCREMENT, \`amount\` float NULL, \`typeVaccineId\` int NULL, \`animalId\` int NULL, \`doseId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
