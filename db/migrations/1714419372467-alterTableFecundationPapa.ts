...
export class AlterTableFecundationPapa1714419372467 implements MigrationInterface {
    name = 'AlterTableFecundationPapa1714419372467'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`fecundation\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`fecundation\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`fecundation\` ADD \`papaId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`animal\` ADD \`sex\` tinyint NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`medical_history\` ADD CONSTRAINT \`FK_e43475f50698820a03be900a5d1\` FOREIGN KEY (\`typeAnimalId\`) REFERENCES \`type_animal\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`animal\` DROP COLUMN \`sex\``);
        await queryRunner.query(`ALTER TABLE \`fecundation\` DROP COLUMN \`papaId\``);
        await queryRunner.query(`ALTER TABLE \`fecundation\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`fecundation\` DROP COLUMN \`created_at\``);
    }
