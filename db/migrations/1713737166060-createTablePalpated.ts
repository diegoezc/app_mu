...
export class CreateTablePalpated1713737166060 implements MigrationInterface {
    name = 'CreateTablePalpated1713737166060'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`vaccine\` ADD \`date\` date NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`vaccine\` DROP COLUMN \`date\``);
